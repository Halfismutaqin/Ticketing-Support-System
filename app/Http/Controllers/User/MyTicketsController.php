...
class MyTicketsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            // Build the query to filter tickets
            $query = Ticket::with(['status', 'priority', 'category', 'assigned_to_user', 'comments'])
                ->filterTickets($request)
                ->where('author_email', $userEmail) // Filter by the authenticated user's email
            ...
            $table->addColumn('view_link', function ($row) {
                // return route('users.tickets.show', $row->id);
            });
        ...
        return view('user.tickets.index', compact('priorities', 'statuses', 'categories'));
    }
    ...
    public function create()
    {
        ...
        return view('user.tickets.create', compact('statuses', 'priorities', 'categories', 'assigned_to_users'));
    }
    ...
    public function edit(Ticket $ticket)
    {
        ...
        return view('user.tickets.edit', compact('statuses', 'priorities', 'categories', 'assigned_to_users', 'ticket'));
    }
