    ...
    <div class="card-body">
        <form action="{{ route("users.tickets.store") }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('author_name') ? 'has-error' : '' }}">
                ...
                <input type="text" id="author_name" name="author_name" class="form-control" value="{{ old('author_name', auth()->user()->name) }}" readonly>
            ...
            <div class="form-group {{ $errors->has('author_email') ? 'has-error' : '' }}">
                ...
                <input type="text" id="author_email" name="author_email" class="form-control" value="{{ old('author_name', auth()->user()->email) }}" readonly>
