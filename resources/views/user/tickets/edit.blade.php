...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route("users.tickets.update", [$ticket->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="form-group {{ $errors->has('author_name') ? 'has-error' : '' }}">
                ...
                <input type="text" id="author_name" name="author_name" class="form-control" value="{{ old('author_name', isset($ticket) ? $ticket->author_name : '') }}" readonly>
            ...
            <div class="form-group {{ $errors->has('author_email') ? 'has-error' : '' }}">
                ...
                <input type="text" id="author_email" name="author_email" class="form-control" value="{{ old('author_email', isset($ticket) ? $ticket->author_email : '') }}" readonly>
...
Dropzone.options.attachmentsDropzone = {
    url: '{{ route('users.tickets.storeMedia') }}',
    maxFilesize: 2, // MB
    addRemoveLinks: true,
    headers: {
